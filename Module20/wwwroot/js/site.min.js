 ...
 * ©2011-2015 SpryMedia Ltd - datatables.net/license
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery","datatables.net"],function(t){return n(t,window,document)}):typeof exports=="object"?module.exports=function(t,i){return t||(t=window),i&&i.fn.dataTable||(i=require("datatables.net")(t,i).$),n(i,t,t.document)}:n(jQuery,window,document)})(function(n,t,i,r){"use strict";function f(){for(var i,t,u,r,f=n("table.mdc-data-table__table").children(),e=0;e<f.length;e++)if(f[e].tagName==="THEAD"){for(i=n(f[e]).children(),console.log(i),t=0;t<i.length;t++)if(i[t].tagName==="TR")for(n(i[t]).addClass("mdc-data-table__header-row"),u=n(i[t]).children(),r=0;r<u.length;r++)u[r].tagName==="TH"&&n(u[r]).addClass("mdc-data-table__header-cell")}else if(f[e].tagName==="TBODY")for(n(f[e]).addClass("mdc-data-table__content"),i=n(f[e]).children(),t=0;t<i.length;t++)if(i[t].tagName==="TR")for(n(i[t]).addClass("mdc-data-table__row"),u=n(i[t]).children(),r=0;r<u.length;r++)u[r].tagName==="TD"&&n(u[r]).addClass("mdc-data-table__cell");console.log(f)}var u=n.fn.dataTable;n.extend(!0,u.defaults,{dom:"<'mdc-layout-grid'<'mdc-layout-grid__inner'<'mdc-cell mdc-layout-grid__cell--span-6'l><'mdc-cell mdc-layout-grid__cell--span-6'f>>><'mdc-layout-grid dt-table'<'mdc-layout-grid__inner'<'mdc-cell mdc-layout-grid__cell--span-12'tr>>><'mdc-layout-grid'<'mdc-layout-grid__inner'<'mdc-cell mdc-layout-grid__cell--span-4'i><'mdc-cell mdc-layout-grid__cell--span-8'p>>>",renderer:"material"});n.extend(u.ext.classes,{sTable:"mdc-data-table__table",sHeaderTH:"mdc-data-table__header-row",sWrapper:"dataTables_wrapper form-inline dt-material mdc-data-table",sFilterInput:"form-control input-sm",sLengthSelect:"form-control input-sm",sProcessing:"dataTables_processing panel panel-default"});u.ext.renderer.pageButton.material=function(t,f,e,o,s,h){var y=new u.Api(t),k=t.oClasses,a=t.oLanguage.oPaginate,b=t.oLanguage.oAria.paginate||{},c,l,p=0,w=function(i,r){for(var k,u,o,d=function(t){t.preventDefault();n(t.currentTarget).hasClass("disabled")||y.page()==t.data.action||y.page(t.data.action).draw("page")},f=0,v=r.length;f<v;f++)if(u=r[f],n.isArray(u))w(i,u);else{c="";o=!1;switch(u){case"ellipsis":c="&#x2026;";l="disabled";break;case"first":c=a.sFirst;l=u+(s>0?"":" disabled");break;case"previous":c=a.sPrevious;l=u+(s>0?"":" disabled");break;case"next":c=a.sNext;l=u+(s<h-1?"":" disabled");break;case"last":c=a.sLast;l=u+(s<h-1?"":" disabled");break;default:c=u+1;l="";o=s===u}o&&(l+=" mdc-button--raised mdc-button--colored");c&&(k=n("<button>",{"class":"mdc-button "+l,id:e===0&&typeof u=="string"?t.sTableId+"_"+u:null,"aria-controls":t.sTableId,"aria-label":b[u],"data-dt-idx":p,tabindex:t.iTabIndex,disabled:l.indexOf("disabled")!==-1}).html(c).appendTo(i),t.oApi._fnBindAction(k,{action:u},d),p++)}},v;try{v=n(f).find(i.activeElement).data("dt-idx")}catch(d){}w(n(f).empty().html('<div class="pagination"/>').children(),o);v!==r&&n(f).find("[data-dt-idx="+v+"]").trigger("focus")};n(i).on("init.dt",function(t,i){if(t.namespace==="dt"){var r=new n.fn.dataTable.Api(i);f()}});n(i).on("draw.dt",function(t,i){if(t.namespace==="dt"){var r=new n.fn.dataTable.Api(i);f()}});return u});
/*! DataTables Bootstrap 3 integration
 * ©2011-2015 SpryMedia Ltd - datatables.net/license
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery","datatables.net"],function(t){return n(t,window,document)}):typeof exports=="object"?module.exports=function(t,i){return t||(t=window),i&&i.fn.dataTable||(i=require("datatables.net")(t,i).$),n(i,t,t.document)}:n(jQuery,window,document)})(function(n,t,i,r){"use strict";var u=n.fn.dataTable;n.extend(!0,u.defaults,{dom:"<'ui stackable grid'<'row'<'eight wide column'l><'right aligned eight wide column'f>><'row dt-table'<'sixteen wide column'tr>><'row'<'seven wide column'i><'right aligned nine wide column'p>>>",renderer:"semanticUI"});n.extend(u.ext.classes,{sWrapper:"dataTables_wrapper dt-semanticUI",sFilter:"dataTables_filter ui input",sProcessing:"dataTables_processing ui segment",sPageButton:"paginate_button item"});u.ext.renderer.pageButton.semanticUI=function(t,f,e,o,s,h){var y=new u.Api(t),b=t.oClasses,a=t.oLanguage.oPaginate,k=t.oLanguage.oAria.paginate||{},c,l,p=0,w=function(i,r){for(var v,u,g=function(t){t.preventDefault();n(t.currentTarget).hasClass("disabled")||y.page()==t.data.action||y.page(t.data.action).draw("page")},d,f=0,o=r.length;f<o;f++)if(u=r[f],n.isArray(u))w(i,u);else{c="";l="";switch(u){case"ellipsis":c="&#x2026;";l="disabled";break;case"first":c=a.sFirst;l=u+(s>0?"":" disabled");break;case"previous":c=a.sPrevious;l=u+(s>0?"":" disabled");break;case"next":c=a.sNext;l=u+(s<h-1?"":" disabled");break;case"last":c=a.sLast;l=u+(s<h-1?"":" disabled");break;default:c=u+1;l=s===u?"active":""}d=l.indexOf("disabled")===-1?"a":"div";c&&(v=n("<"+d+">",{"class":b.sPageButton+" "+l,id:e===0&&typeof u=="string"?t.sTableId+"_"+u:null,href:"#","aria-controls":t.sTableId,"aria-label":k[u],"data-dt-idx":p,tabindex:t.iTabIndex}).html(c).appendTo(i),t.oApi._fnBindAction(v,{action:u},g),p++)}},v;try{v=n(f).find(i.activeElement).data("dt-idx")}catch(d){}w(n(f).empty().html('<div class="ui stackable pagination menu"/>').children(),o);v!==r&&n(f).find("[data-dt-idx="+v+"]").trigger("focus")};n(i).on("init.dt",function(t,i){if(t.namespace==="dt"){var r=new n.fn.dataTable.Api(i);n.fn.dropdown&&n("div.dataTables_length select",r.table().container()).dropdown();n("div.dataTables_filter.ui.input",r.table().container()).removeClass("input").addClass("form");n("div.dataTables_filter input",r.table().container()).wrap('<span class="ui input" />')}});return u});
